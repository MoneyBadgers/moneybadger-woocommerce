...
final class MoneyBadger_Blocks_Support extends AbstractPaymentMethodType {
	/**
    ...
    $asset_path   = MONEYBADGER_PLUGIN_PATH . '/assets/index.asset.php';
    $dependencies = array();
    if ( file_exists( $asset_path ) ) {
		...
		wp_register_script(
			'moneybadger',
			MONEYBADGER_PLUGIN_URL.'/assets/js/moneybadger.js',
			$dependencies,
			'1.0.0',
			true
		);
